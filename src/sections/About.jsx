      ...
      <div className='container-1200 mb-36'>
        ...
        <div className='flex gap-24 relative'>
          <div className='flex grow z-10 flex-col'>
            <img src='img/woman1.png' alt='woman1' className='w-full mb-10'></img>
          ...
          <div className='w-2/3 flex z-10 flex-col grow'>
            ...
            <img src='img/woman2.png' alt='woman2' className='grow'></img>
          </div>

          <img src='extra/ellipse.svg' alt='ellipse' className='absolute top-[-2.5rem] left-[-6.25rem] z-0'></img>
          <img src='extra/leaf1.svg' alt='leaf' className='absolute top-0 right-[-15rem] z-0'></img>
        </div>
      </div>
  );
};
